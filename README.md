...
| isMarkedForManualRelease        | Boolean                                           | When true the file is held for manual release after CurseForge approves it instead of being released automatically. This is optional and defaults to false.                                |
